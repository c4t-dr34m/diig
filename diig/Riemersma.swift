...
final class Riemersma {
    ...
    private static let size = 92 // number of pixels remembered while traversing the image
    private static let weightDiff = 16 // basically contrast of the resulting image
